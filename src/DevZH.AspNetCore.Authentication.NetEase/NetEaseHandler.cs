...
namespace DevZH.AspNetCore.Authentication.NetEase
{
    ...
    public class NetEaseHandler : OAuthHandler<NetEaseOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> CreateTicketAsync(ClaimsIdentity identity, AuthenticationProperties properties, OAuthTokenResponse tokens)
        {
            ...
            {
                throw new HttpRequestException($"Failed to retrieve NetEase user information ({response.StatusCode}) Please check if the authentication information is correct and the corresponding NetEase API is enabled.");
            }
