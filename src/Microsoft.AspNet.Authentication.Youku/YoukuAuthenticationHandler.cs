...
namespace Microsoft.AspNet.Authentication.Youku
{
    ...
    ///  优酷开放平台授权核心处理类
    /// </summary>
    public class YoukuAuthenticationHandler : OAuthAuthenticationHandler<YoukuAuthenticationOptions>
    {
        public YoukuAuthenticationHandler(HttpClient backchannel) : base(backchannel) { }
        ...
        protected override async Task<AuthenticationTicket> CreateTicketAsync(ClaimsIdentity identity, AuthenticationProperties properties, OAuthTokenResponse tokens)
        {
            ...
            var identifier = YoukuAuthenticationHelper.GetId(payload);
            ...
            var name = YoukuAuthenticationHelper.GetName(payload);
            ...
            var avatar = YoukuAuthenticationHelper.GetAvatar(payload);
