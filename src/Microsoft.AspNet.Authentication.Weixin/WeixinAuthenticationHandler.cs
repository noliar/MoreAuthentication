...
namespace Microsoft.AspNet.Authentication.Weixin
{
    ...
    ///  微信授权登录处理核心类
    /// </summary>
    public class WeixinAuthenticationHandler : OAuthAuthenticationHandler<WeixinAuthenticationOptions>
    {
        public WeixinAuthenticationHandler(HttpClient backchannel) : base(backchannel)
        {
        }
