...
namespace Microsoft.AspNet.Authentication.Tencent
{
    ...
    ///  腾讯开放平台用户接入授权处理核心类
    /// </summary>
    public class TencentAuthenticationHandler : OAuthAuthenticationHandler<TencentAuthenticationOptions>
    {
        public TencentAuthenticationHandler(HttpClient backchannel) : base(backchannel) { }
        ...
        protected override async Task<AuthenticationTicket> CreateTicketAsync(ClaimsIdentity identity, AuthenticationProperties properties, OAuthTokenResponse tokens)
        {
            ...
            var identifier = TencentAuthenticationHelper.GetOpenId(json);
