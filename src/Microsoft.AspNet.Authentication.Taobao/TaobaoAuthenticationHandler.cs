...
namespace Microsoft.AspNet.Authentication.Taobao
{
    ...
    ///  淘宝授权核心处理类
    /// </summary>
    public class TaobaoAuthenticationHandler : OAuthAuthenticationHandler<TaobaoAuthenticationOptions>
    {
        public TaobaoAuthenticationHandler(HttpClient backchannel) : base(backchannel) { }
