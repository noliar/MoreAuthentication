...
namespace Microsoft.AspNet.Authentication.Sina
{
    ...
    /// 新浪用户授权过程中所涉及到的基本信息
    /// </summary>
    public class SinaAuthenticationOptions : OAuthAuthenticationOptions
    {
        ...
        {
            AuthenticationScheme = SinaAuthenticationDefaults.AuthenticationScheme;
            Caption = AuthenticationScheme;
            CallbackPath = new Http.PathString("/signin-sina");
            AuthorizationEndpoint = SinaAuthenticationDefaults.AuthorizationEndpoint;
            TokenEndpoint = SinaAuthenticationDefaults.TokenEndpoint;
            UserInformationEndpoint = SinaAuthenticationDefaults.UserInformationEndpoint;
        }
        ...
        public DisplayStyle Display {
            ...
            set
            {
                ...
                AuthorizationEndpoint =
                  ...
                  ? SinaAuthenticationDefaults.AuthorizationEndpointMobile
                  : SinaAuthenticationDefaults.AuthorizationEndpoint;
            }
        }
